<?php
    ...
    $id_user = $_GET['id'];
    $query = "SELECT * FROM auth WHERE id_user = '$id_user'";
    ...
    if (isset($_POST['btn-simpan'])) {
        ...
        if ($_POST['password'] != null || $_POST['password'] == '') {
            ...
            $query = "UPDATE auth SET nama_user = '$nama', username = '$username', role = '$role', password = '$password' WHERE id_user = '$id_user'";
        } else {
            $query = "UPDATE auth SET nama_user = '$nama', username = '$username', role = '$role' WHERE id_user = '$id_user'";
        }

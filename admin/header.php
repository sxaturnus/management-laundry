...
<head>
    ...
    <title>Admin | El-Laundry</title>
    <meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
    <link rel="icon" href="../assets/auth/img/favicon.png" type="image/x-icon" />
    ...
    <style>
        .navbar-header {
            background-color: #024C01 !important;
        }
...
<body>
    <div class="wrapper">
        <div class="main-header">
            <!-- Logo Header -->
            <div class="logo-header" data-background-color="dark-green">
